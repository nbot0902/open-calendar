      ...
      <div className={s.terms}>
        ...
        <div className={s.terms_row}>
          ...
          <ol className={s.terms_list_a}>
            ...
            <li className={s.terms_list_a_item}>
              「オーガナイザー情報」とは、オーガナイザーがカスタマーに向けて活動内容を説明するためのオーガナイザーのプロフィール情報を意味します。
            </li>
            <li className={s.terms_list_a_item}>
              「オーガナイザーサービス」とは、オーガナイザーがカスタマーに対して提供するサービス、レッスン、オンラインイベント、交流会、などの総称を意味します。
            </li>
            <li className={s.terms_list_a_item}>
              「オーガナイザーページ」とは、オーガナイザーがオーガナイザー情報やオーガナイザービスを提供するために本サービス上で作る専用Webページを意味します。
            </li>
            <li className={s.terms_list_a_item}>
        ...
        <div className={s.terms_row}>
          <div className={s.terms_row_title}>
            <div className={s.terms_row_title_text}>
              第7条 オーガナイザー情報の管理機能、等
            </div>
          </div>
          <ol className={s.terms_list_a}>
            <li className={s.terms_list_a_item}>
              オーガナイザーは、当方の定める方法により、オーガナイザー情報の作成及び変更を行うことができるものとします。
            </li>
            <li className={s.terms_list_a_item}>
              オーガナイザーは、オーガナイザー情報の作成及び変更にあたり、法令に違反し、また、第三者の権利を侵害しないように留意すると共に、オーガナイザー情報に掲載された文章、画像その他の情報が、第三者のいかなる権利も侵害していないことを当方に保証するものとします。
            </li>
            <li className={s.terms_list_a_item}>
              オーガナイザーは、オーガナイザー情報の作成及び変更にあたり、当方が登録禁止情報として定める内容を、オーガナイザーサービスとして登録してはなりません。登録禁止情報の一覧はこちらをご確認ください。
            </li>
            <li className={s.terms_list_a_item}>
              オーガナイザーは、特定商取引に関する法律で要求される事項及び当方が要求する事項を、 オーガナイザー情報において適切に表示しなければならないものとし、表示内容及び方法について当方からの指示がある場合、当該指示に従って適切に表示しなければならないものとします。オーガナイザーは、特定商取引に関する法律で要求される事項及び当方が要求する事項を適切に表示した場合に限り、オーガナイザーサービス実施契約を締結することができるものとします。
            </li>
            <li className={s.terms_list_a_item}>
              当方は、オーガナイザーが本規約に違反していると判断した場合、当方の裁量において、 当該オーガナイザーが作成したオーガナイザー情報に記載された情報の全部又は一部について削除、変更、公開停止その他の措置をとることができるものとします。
            </li>
            <li className={s.terms_list_a_item}>
              前項の定めにかかわらず、当方は、オーガナイザー情報を確認する義務を負わず、その内容に起因して生じたトラブル(オーガナイザーと他のユーザー、外部サービス事業者又は第三者との間で生じたトラブルを含みます。)について、一切の責任を負いません。
            </li>
            <li className={s.terms_list_a_item}>
        ...
        <div className={s.terms_row}>
          ...
          <ol className={s.terms_list_a}>
            <li className={s.terms_list_a_item}>
              当方は、ユーザーから提供された個人情報(個人情報の保護に関する法律第2条第1項に定める「個人情報」を意味します。以下同じ。)を本サービスの提供に必要な範囲及び当方が別途定める<a href="/privacy_policy" target="_blank" >プライバシーポリシー</a>で定められた目的の範囲で使用することができるものとします。
            </li>
            <li className={s.terms_list_a_item}>
        ...
        <div className={s.terms_row}>
          ...
          <ol className={s.terms_list_a}>
            ...
            <li className={s.terms_list_a_item}>
              ユーザーが本条に規定に基づきユーザーの登録を取り消した場合、当方は、当方の裁量により、当該ユーザーが本サービス上で保有していた情報及び成果物(オーガナイザー情報を含みますが、これらに限定されません。)を削除することができるものとし、これによって当該ユーザーに生じた損害について一切の責任を負わないものとします。
            </li>
          </ol>
        </div>
