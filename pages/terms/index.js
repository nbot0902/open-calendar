  ...
  return (
    ...
    >
      ...
      <div className={s.terms}>
        <PageHead title={"利用規約"} description={`本利用規約(以下「本規約」といいます。)には、${C.SERVICE_NAME}運営者(以下「当方」といいます。)の提供する本サービス(第2条に定義)のご利用にあたり、ユーザー(第2条に定義)の皆様に遵守していただかなければならない事項及び当方とユーザーの皆様との間の権利義務関係が定められております。本サービスをユーザーとしてご利用になる方は、本規約に同意する前に、必ず全文お読み下さいますようお願い致します。`} />
